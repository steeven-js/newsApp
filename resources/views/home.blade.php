                    ...
                    @forelse ($news as $itennews)
                        <div class="m-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700 mb-2">{{ Str::limit($itennews->description, 150) }}</p>
                                <div class="flex justify-between mt-4">
                                    <span
                                        class="font-thin text-sm">{{ date('d-m-Y', strtotime($itennews->updated_at)) }}
                                    </span>
                                    <a href="{{ route('show', $itennews->id) }}"
                                        class="bg-blue-300 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded inline-flex items-center">
